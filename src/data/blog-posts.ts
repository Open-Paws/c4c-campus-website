export interface BlogPost {
  ...
  description: string;
  date: string;
  category: 'News' | 'Community' | 'Technical' | 'Impact';
  author: string;
  content: string;
}
...
export const blogPosts: BlogPost[] = [
  {
    slug: 'welcome-to-c4c-campus',
    title: 'Welcome to Code for Compassion Campus',
    description: 'Introducing our global AI innovation hub — training developers to build responsible, impact-driven technology for animal advocacy, climate action, and AI safety.',
    date: '2026-02-10',
    category: 'News',
    author: 'C4C Team',
    content: `
...
<p>Applications are open year-round. Whether you're a complete beginner or an experienced developer looking to apply your skills to something meaningful, there's a place for you here.</p>
  ...
  {
    slug: 'ai-tools-for-animal-advocacy',
    title: 'Building AI Tools for Animal Advocacy: Where to Start',
    description: 'A practical overview of how AI is being used to protect animals — from supply chain transparency to rescue coordination — and how you can contribute.',
    date: '2026-02-05',
    category: 'Technical',
    author: 'C4C Team',
    content: `
...
<p>Our bootcamp covers the fundamentals. Our hackathons give you a chance to build real prototypes with real users. And our accelerator takes the best projects to production.</p>
  ...
  {
    slug: 'first-hackathon-recap',
    title: 'Our First Global Hackathon: What We Built',
    description: 'A look back at our inaugural hackathon — the teams, the projects, and the prototypes that are now heading into development.',
    date: '2026-01-28',
    category: 'News',
    author: 'C4C Team',
    content: `
...
<p>Several teams from the hackathon are now applying to our accelerator programme to take their prototypes to production. We'll be announcing the next hackathon date soon — follow us for updates.</p>
  ...
  {
    slug: 'from-bootcamp-to-accelerator',
    title: 'From Bootcamp to Accelerator: One Student\'s Journey',
    description: 'How a bootcamp graduate went from zero coding experience to building an AI tool for wildlife monitoring — and what she learned along the way.',
    date: '2026-01-20',
    category: 'Community',
    author: 'C4C Team',
    content: `
...
<p>"The biggest thing I've learned is that you don't need to be a genius programmer to build something useful. You need to understand the problem deeply and be willing to learn as you go."</p>
  ...
  },
  {
    ...
    title: 'Ethical AI Development: Our Guiding Principles',
    description: 'The principles that guide how we teach and build AI at C4C Campus — because technology without ethics is just a faster way to cause harm.',
    date: '2026-01-12',
    category: 'Technical',
    author: 'C4C Team',
    content: `
...
<p>These aren't just posters on the wall. Every project in our bootcamp, hackathons, and accelerator is evaluated against these principles. We conduct ethics reviews as part of our development process, and our mentors actively push teams to consider the implications of their design decisions.</p>
  ...
  {
    slug: 'arcc-pre-accelerator-announcement',
    title: 'Introducing ARCC: The Animal Rights Coding Camp',
    description: 'A new 4-week pre-accelerator programme specifically for teams building technology to protect animals. Arrive with a prototype, pitch to investors in week one.',
    date: '2026-01-05',
    category: 'News',
    author: 'C4C Team',
    content: `
...
export const categories = ['All Posts', 'News', 'Community', 'Technical', 'Impact'] as const;
